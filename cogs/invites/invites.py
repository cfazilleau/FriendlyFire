...
class Invites(BaseCog):
    ...
    greetingsGroup = discord.SlashCommandGroup(name="greetings", description="manage greetings", default_member_permissions=ADMIN_PERMS, guild_only=True)
    ...
    @discord.slash_command(name="invite", description="Generates a temporary invite", default_member_permissions=ADMIN_PERMS, guild_only=True)
    ...
    @discord.slash_command(name="test_join", description="Generates a temporary invite", default_member_permissions=ADMIN_PERMS, guild_only=True)
